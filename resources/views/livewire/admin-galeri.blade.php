...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-wrap items-stretch w-1/3 mb-4 ml-4 relative">
                <input wire:model="search" type="text"
                    class="flex-shrink flex-grow flex-auto leading-normal w-px flex border h-10 border-grey-light rounded rounded-r-none px-3 relative"
                    placeholder="Cari disini">
                <div class="flex -mr-px">
                    <span
                        class="flex items-center leading-normal bg-gray-800 rounded rounded-l-none border border-l-0 border-gray-600 px-3 whitespace-no-wrap text-white text-sm">
            ...
            {{-- Button --}}
            <div>
                <button wire:click="openModal()" @click="showModal1 = true" type="button"
                ...
                @if ($modal)
                @include('create.createGaleri')
                @endif

                {{-- Modal View --}}
                @if ($viewModal)
                @include('create.viewGaleri')
                @endif
                {{-- Modal View --}}
                ...
                <div x-data="{ showModal1: true }" :class="{'overflow-y-hidden': showModal1 }">
                    ...
                    <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
                        ...
                        <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
                            <div class="relative bg-white p-6 shadow-lg rounded-md text-gray-900 z-20"
                                ...
                                <header class="flex items-center justify-between ">
                                    ...
                                    <button class="focus:outline-none p-2" wire:click="closeDeleteModal()">
        ...
        <div class="">
            <div
                class="bg-white p-2 w-full mx-3 sm:w-full sm:py-4 h-auto sm:h-2/3 rounded-2xl shadow-lg flex flex-col  justify-center items-center sm:flex-row gap-5 select-none">
