...
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Dokumen</h2>
</x-slot>
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="">
            <div class="bg-white p-2 w-full mx-1 sm:w-full sm:py-4 h-auto sm:h-2/3 rounded-2xl shadow-lg flex flex-col  justify-center items-center sm:flex-row gap-5 select-none">
